		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DemoBillingValidation01",
									"targetURL": "#dbv01billingvalidation240518-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dbv01billingvalidation240518-display": {
								"semanticObject": "dbv01billingvalidation240518",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dbv01.billingvalidation240518",
									"url": sap.ui.require.toUrl("dbv01/billingvalidation240518")
								}
							}
						}
					}
